...
/**
 * 危险废物_管理计划_18危险废物减量化信息对象 pp_wxfw_year_plan_waste_minimization
 *
 * @author gzl
 * @date 2023-02-09
 */
...
@Getter
@ToString
@ApiModel("危险废物_管理计划_18危险废物减量化信息")
@TableName("pp_wxfw_year_plan_waste_minimization")
public class YearPlanWasteMinimization implements Serializable {
    ...
    @Size(max = 200, message = "废物详细名称最多输入200个字符")
