package com.crcm.cloud.start.job;

import com.crcm.cloud.start.job.properties.XxlExecutorProperties;
import com.crcm.cloud.start.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
    ...
    public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
        ...
        // 如果配置为空则获取注册中心的服务列表 "http://crcm-cloud-xxl-admin/xxl-job-admin"
