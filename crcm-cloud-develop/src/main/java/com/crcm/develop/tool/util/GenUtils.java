...
import com.crcm.develop.core.conf.CodeGenConfig;
...
public class GenUtils {
    ...
    @Autowired
    public GenUtils(CodeGenConfig codeGenConfig) {
        GenUtils.codeGenConfig = codeGenConfig;
    }
    ...
    public static String convertClassName(String tableName) {
        boolean autoRemovePre = codeGenConfig.isAutoRemovePre();
        String tablePrefix = codeGenConfig.getTablePrefix();
