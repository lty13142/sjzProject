...
/**
 * 危险废物_经营年报_09新产生危废委外处置对象 pp_wxfw_business_year_report_new_waste_outsourcing_disposal
 *
 * @author gzl
 * @date 2023-02-09
 */
...
@Getter
@ToString
@ApiModel("危险废物_经营年报_09新产生危废委外处置")
@TableName("pp_wxfw_business_year_report_new_waste_outsourcing_disposal")
public class BusinessYearReportNewWasteOutsourcingDisposal implements Serializable {
    ...
    @Size(max = 200, message = "接收省份最多输入200个字符")
