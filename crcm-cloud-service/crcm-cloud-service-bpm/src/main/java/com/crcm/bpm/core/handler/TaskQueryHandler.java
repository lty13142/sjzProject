...
import com.crcm.bpm.core.ifs.ActTaskQuery;
import com.crcm.bpm.core.config.ServiceFactory;
import com.crcm.bpm.core.common.VariablesEnum;
...
public class TaskQueryHandler extends ServiceFactory implements ActTaskQuery {
    ...
    public TaskVO queryTaskVOById(String taskId) {
        ...
        if (task == null) {
            throw new BpmException("错误，ID为 "+taskId+" 的任务不存在", BpmError.DATA_NOT_FOUND_ERROR);
        }
