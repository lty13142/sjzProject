...
import com.crcm.core.exception.ValidateException;
...
@Slf4j
@UtilityClass
public class WebsUtil extends org.springframework.web.util.WebUtils {
	...
	public String getCookieVal(String name) {
		HttpServletRequest request = WebsUtil.getRequest();
	 ...
	 */
	public String getIP() {
		return getIP(WebsUtil.getRequest());
	}
