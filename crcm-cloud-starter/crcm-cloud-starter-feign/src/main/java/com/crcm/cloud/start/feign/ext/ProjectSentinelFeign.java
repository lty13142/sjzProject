 ...
 * @date 2020/6/9
 */
public final class ProjectSentinelFeign {

	private ProjectSentinelFeign() {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new ProjectSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new ProjectSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new ProjectSentinelInvocationHandler(target, dispatch);
				}
