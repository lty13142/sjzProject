...
@TableName("bpm_model_use_log")
@ApiModel(value="ModelUseLog对象", description="模板管理日志")
public class ModelUseLogDO implements Serializable {
    ...
    public ModelUseLogDO(){}

    public ModelUseLogDO(Long id, String useUri, String useMethod, String useUserId, String useUserName,
