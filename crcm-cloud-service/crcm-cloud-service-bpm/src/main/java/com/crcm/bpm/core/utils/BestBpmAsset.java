...
public class BestBpmAsset {
    ...
    public static void isEmpty(@Nullable Object obj, String message) {
        if (isEmpty(obj)) {
            throw BpmException.builder().bpmError(new BpmError(BpmError.ILLEGAL_CHECK_ERROR.getCode(),message)).build();
        }
    }
    public static void isAssetEmpty(@Nullable Object obj) {
        if (isEmpty(obj)) {
            throw BpmException.builder().bpmError(BpmError.ILLEGAL_CHECK_ERROR).build();
        }
    }
    public static void isAssetEmptyByDefault(@Nullable Object obj) {
        if (isEmpty(obj)) {
            throw BpmException.builder().bpmError(new BpmError(BpmError.ILLEGAL_CHECK_ERROR.getCode()," is not allow empty ")).build();
        }
    }
    ...
    public static void isTrue(boolean expression, Supplier<String> messageSupplier) {
        if (!expression) {
            throw BpmException.builder().bpmError(new BpmError(BpmError.ILLEGAL_CHECK_ERROR.getCode(),nullSafeGet(messageSupplier))).build();
        }
    }
    ...
    public static void notEmpty(@Nullable Collection<?> collection, String message) {
        if (CollectionUtils.isEmpty(collection)) {
            throw BpmException.builder().bpmError(new BpmError(BpmError.ILLEGAL_ARGUMENT_ERROR.getCode(),message)).build();
        }
    }
    ...
    public static void noNullElements(@Nullable Collection<?> collection, Supplier<String> messageSupplier) {
        if (collection != null) {
            for (Object element : collection) {
                if (element == null) {
                    throw BpmException.builder().bpmError(new BpmError(BpmError.ILLEGAL_ARGUMENT_ERROR.getCode(),nullSafeGet(messageSupplier))).build();
                }
            }
        }
    }
