...
public class InstanceController {
    ...
    public RestResult startByName(String name, String tenantId, @RequestBody Map<String, Object> variables) {
        ...
        for (Task task : list) {
            tasks.add(BeanUtil.copyProperties(task, TaskVO.class));
        }
        return RestResult.succeed(tasks);
    }
    ...
    public RestResult<TaskVO> startById(String id, @RequestBody Map<String, Object> variables) {
    ...
    public RestResult startAndExecute(String name, String tenantId, String userId, @RequestBody Map<String, Object> variables) throws Exception {
    ...
    public RestResult startAndExecuteAndSetActor(String name, String tenantId, String userId,
    ...
    public RestResult suspendById(String processInstanceId) throws Exception {
        instanceHandler.suspendProcessInstanceById(processInstanceId);
        return RestResult.succeed("流程实例挂起成功");
    }
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "processInstanceId", value = "流程实例ID", required = true, dataType = "String")})
    public RestResult activateById(String processInstanceId) throws Exception {
        instanceHandler.activateProcessInstanceById(processInstanceId);
        return RestResult.succeed("激活流程实例");
    }
    ...
    public RestResult addMultiInstanceExecution(String activityDefId, String instanceId, @RequestBody Map<String, Object> variables) {
        instanceHandler.addMultiInstanceExecution(activityDefId, instanceId, variables);
        return RestResult.succeed("加签成功");
    }
    ...
    public RestResult deleteMultiInstanceExecution(String currentChildExecutionId, boolean flag) {
        instanceHandler.deleteMultiInstanceExecution(currentChildExecutionId, flag);
        return RestResult.succeed("减签成功");
    }
}
